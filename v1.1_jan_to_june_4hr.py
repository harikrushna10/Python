...
def main():
    ...
    # Configuration
    start_epoch = 1735689600  # January 1, 2025 00:00:00 UTC
    end_epoch = 1751328000    # February 1, 2025 00:00:00 UTC (end of January)
    version = "v1.1"
    duration_hours = 4 
    ...
    while current_time <= end_epoch:
        ...
        Month="jan"
        excel_filename = f'backtest_results_jan_to_june_{version}_{duration_hours}h.xlsx'
        ...
        # else:
        #     # File doesn't exist, just write new results
        #     df_results.to_excel(excel_filename, index=False)
        #     # df_results.to_excel(excel_filename, index=False)
