...
def main():
    ...
    # Configuration
    start_epoch = 1748723919 
    end_epoch = 1749552810
    version = "v2.1"
    duration_hours = 2 
    ...
    while current_time <= end_epoch:
        ...
        Month="jan"
        excel_filename = f'backtest_results_10_{version}_{duration_hours}h.csv'
                # Instead of recreating the whole DataFrame every time
