...
def main():
    ...
    # Configuration
    start_epoch = 1743467100

  # April 1, 2025 00:00:00 UTC
    end_epoch = 1743467100

    # May 1, 2025 00:00:00 UTC (end of April)
    version = "v2.1"
    duration_hours = 2
    ...
    while current_time <= end_epoch:
        ...
        excel_filename = f'backtest_results_{Month}_{version}_{duration_hours}h_{unique_suffix}.xlsx'
